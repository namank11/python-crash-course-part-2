...
get_data(file_name_san_francisco, san_francisco_dates, san_francisco_highs, san_francisco_lows)
...
ax.plot(death_valley_dates, death_valley_highs, c='blue', alpha=0.5)
ax.plot(death_valley_dates, death_valley_lows, c='yellow', alpha=0.5)
plt.fill_between(death_valley_dates, death_valley_highs, death_valley_lows, facecolor='blue', alpha=0.1)
ax.plot(san_francisco_dates, san_francisco_highs, c='red', alpha=0.5)
ax.plot(san_francisco_dates, san_francisco_lows, c='green', alpha=0.5)
plt.fill_between(san_francisco_dates, san_francisco_highs, san_francisco_lows, facecolor='blue', alpha=0.1)
